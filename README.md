# Financial Index Profile Client Java
...
En el archivo **FipApiTest**, que se encuentra en ***src/test/java/io/fip/client/api/***. Se deberá modificar los datos de la petición y de la URL para el consumo de la API en ***setBasePath("the_url")***, como se muestra en el siguiente fragmento de código con los datos correspondientes:
